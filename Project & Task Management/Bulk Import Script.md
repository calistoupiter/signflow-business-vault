---
title: Bulk Import Script for GitHub Issues
version: 1.0.0
created: 2025-01-25
updated: 2025-01-25
tags: [signflow, github, bulk-import, automation]
---

# Bulk Import Script for GitHub Issues

## Method 1: GitHub CLI Bulk Import (Recommended)
...
## Method 2: GitHub Web Interface (Faster Manual)

If you prefer the web interface, here's the quickest approach:

1. **Go to your repository issues**: https://github.com/calistoupiter/GitHubVault/issues
2. **Click "New Issue"** 
3. **Use this rapid-fire format:**

```
Title: make zoom/facetime calls with leads >=$5k
Labels: ideas, business-development
Body: **Column:** Ideas
```

## Method 3: CSV Import (If GitHub supports it)

Some third-party tools can import from CSV. Here's the data formatted:

```csv
Title,Body,Labels,Status
"make zoom/facetime calls with leads >=$5k","**Column:** Ideas","ideas,business-development","Ideas"
"truncated LP for split testing, just form & social proof","**Column:** Ideas","ideas,landing-page,testing","Ideas"
"check load speed for clients' LPs","**Column:** Ideas","ideas,landing-page,optimization","Ideas"
...
```

## Recommendation

**Use Method 1 (GitHub CLI)** - it's the fastest and most accurate. Takes about 2-3 minutes to run the entire script and creates all 42 issues with proper labels and organization.

Want me to modify the script for any specific customizations? 